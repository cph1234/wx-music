...
__DEFINE__(1649929643550, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1649929643551,"./event-store":1649929643552}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1649929643551, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1649929643552, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1649929643551,"./utils":1649929643553}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1649929643553, function(require, module, exports) {
...
return __REQUIRE__(1649929643550);
})()
